...
class ExportController extends Controller
{
    ...
    public function exportcc(Request $request)
    {
        try {
            ...
            $sheet->setCellValue('Q1', 'Jawaban1');
            $sheet->setCellValue('R1', 'Jawaban2');
            $sheet->setCellValue('S1', 'Jawaban3');
            $sheet->setCellValue('T1', 'Jawaban4');
            $sheet->setCellValue('U1', 'Jawaban5');
            $sheet->setCellValue('V1', 'Jawaban6');
            $sheet->setCellValue('W1', 'Jawaban7');
