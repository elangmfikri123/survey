...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Export Awareness Contact Center</h1>
        ...
        <div class="section-body">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Export Template Survey Awareness CC</h4>
                        </div>
                        <div class="card-body">
                          <form class="form-inline" action="{{ url('/export-url') }}" method="get">
                            @csrf
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Export Hasil Survey Awareness CC</h4>
                </div>
                <div class="card-body">
                    <form class="form-inline" action="{{ url('/export-awarenesscc') }}" method="get">
                        @csrf
