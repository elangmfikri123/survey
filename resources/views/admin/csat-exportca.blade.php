...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Export CSAT Customer Assistance</h1>
        ...
        <div class="section-body">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Export Template Survey CSAT Customer Assistance</h4>
                        </div>
                        <div class="card-body">
                          <form class="form-inline" action="{{ url('/export-urlcsatca') }}" method="get">
                            @csrf
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Export Hasil Survey CSAT Customer Assistance</h4>
                </div>
                <div class="card-body">
                    <form class="form-inline" action="{{ url('/export-csathasilca') }}" method="get">
                        @csrf
      ...
      $('#exportButton').on('click', function () {
          ...
          $.ajax({
              ...
              success: function () {
                  ...
                  alert('Export URL CSAT CA berhasil!');
              },
