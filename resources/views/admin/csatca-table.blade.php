...
@section('title', 'CSAT Customer Assistance')
@section('content')
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4>Data Survey CSAT Customer Assistance</h4>
              </div>
              <div class="card-body">

                <form action="{{ url('/import-csatca') }}" method="POST" enctype="multipart/form-data">
                  @csrf
