...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Export Template Survey CSAT Honda Care</h4>
                        </div>
                        <div class="card-body">
                          <form class="form-inline" action="{{ url('/export-urlcsathc') }}" method="get">
                            @csrf
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Export Hasil Survey CSAT Honda Care</h4>
                </div>
                <div class="card-body">
                    <form class="form-inline" action="{{ url('/export-csathasilhc') }}" method="get">
                        @csrf
